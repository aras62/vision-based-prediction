...
<li> Jung et al., "Goal-Directed Behavior Under Variational Predictive Coding: Dynamic Organization Of Visual Attention And Working Memory", IROS, 2019. <a href="papers.md#data_Jung_2019_IROS">info</a></li>
...
<li> Luo et al., "Human Intention Inference And On-Line Human Hand Motion Prediction For Human-Robot Collaboration", IROS, 2019. <a href="papers.md#data_Luo_2019_IROS">info</a></li>
<li> Wu et al., "Gaze-Based Intention Anticipation Over Driving Manoeuvres In Semi-Autonomous Vehicles", IROS, 2019. <a href="papers.md#data_Wu_2019_IROS">info</a></li>
...
<li> Bütepage et al., "Anticipating Many Futures: Online Human Motion Prediction And Generation For Human-Robot Interaction", ICRA, 2018. <a href="papers.md#data_Butepage_2018_ICRA">info</a></li>
...
<li> Strickland et al., "Deep Predictive Models For Collision Risk Assessment In Autonomous Driving", ICRA, 2018. <a href="papers.md#data_Strickland_2018_ICRA">info</a></li>
...
<li> Su et al., "Predicting Behaviors Of Basketball Players From First Person Videos", CVPR, 2017. <a href="papers.md#data_Su_2017_CVPR">info</a></li>
...
<li> Felsen et al., "What Will Happen Next? Forecasting Player Moves In Sports Videos", ICCV, 2017. <a href="papers.md#data_Felsen_2017_ICCV">info</a></li>
...
<li> Rhinehart et al., "First-Person Activity Forecasting With Online Inverse Reinforcement Learning", ICCV, 2017. <a href="papers.md#data_Rhinehart_2017_ICCV">info</a></li>
...
<li> Park et al., "Hi Robot: Human Intention-Aware Robot Planning For Safe And Efficient Navigation In Crowds", IROS, 2016. <a href="papers.md#data_Park_2016_IROS">info</a></li>
<li> Schneemann et al., "Context-Based Detection Of Pedestrian Crossing Intention For Autonomous Driving In Urban Environments", IROS, 2016. <a href="papers.md#data_Schneemann_2016_IROS">info</a></li>
...
<li> V\"olz et al., "A Data-Driven Approach For Pedestrian Intention Estimation", ITSC, 2016. <a href="papers.md#data_Volz_2016_ITSC">info</a></li>
...
<li> Pérez-D'Arpino et al., "Fast Target Prediction Of Human Reaching Motion For Cooperative Human-Robot Manipulation Tasks Using Time Series Classification", ICRA, 2015. <a href="papers.md#data_Arpino_2015_ICRA">info</a></li>
...
<li> Hashimoto et al., "Probability Estimation For Pedestrian Crossing Intention At Signalized Crosswalks", ICVES, 2015. <a href="papers.md#data_Hashimoto_2015_ICVES">info</a></li>
<li> K\"ohler et al., "Stereo-Vision-Based Pedestrian'S Intention Detection In A Moving Vehicle", ITSC, 2015. <a href="papers.md#data_Kohler_2015_ITSC">info</a></li>
<li> V\"olz et al., "Feature Relevance Estimation For Learning Pedestrian Behavior At Crosswalks", ITSC, 2015. <a href="papers.md#data_Volz_2015_ITSC">info</a></li>
...
<li> Alati et al., "Help By Predicting What To Do", ICIP, 2019. <a href="papers.md#data_Alati_2019_ICIP">info</a></li>
<li> Furnari et al., "Egocentric Action Anticipation By Disentangling Encoding And Inference", ICIP, 2019. <a href="papers.md#data_Furnari_2019_ICIP">info</a></li>
<li> Wang et al., "A Learning-Based Prediction Model For Baby Accidents", ICIP, 2019. <a href="papers.md#data_Wang_2019_ICIP">info</a></li>
<li> Suzuki et al., "Anticipating Traffic Accidents With Adaptive Loss And Large-Scale Incident Db", The CVPR, 2018. <a href="papers.md#data_Suzuki_2018_CVPR">info</a></li>
<li> Casas et al., "Intentnet: Learning To Predict Intention From Raw Sensor Data", CORL, 2018. <a href="papers.md#data_Casas_2018_CORL">info</a></li>
<li> Mahmud et al., "Joint Prediction Of Activity Labels And Starting Times In Untrimmed Videos", ICCV, 2017. <a href="papers.md#data_Mahmud_2017_ICCV">info</a></li>
<li> Kwak et al., "Pedestrian Intention Prediction Based On Dynamic Fuzzy Automata For Vehicle Driving At Nighttime", Infrared Physics \\& Technology, 2017. <a href="papers.md#data_Kwak_2017_IPT">info</a></li>
...
<li> Wang et al., "A Learning-Based Prediction Model For Baby Accidents", ICIP, 2019. <a href="papers.md#data_Wang_2019_ICIP">info</a></li>
<li> Chan et al., "Anticipating Accidents In Dashcam Videos", ACCV, 2017. <a href="papers.md#data_Chan_2016_ACCV">info</a></li>
</ul>
</details>
...
<li> Hong et al., "Rules Of The Road: Predicting Driving Behavior With A Convolutional Model Of Semantic Interactions", CVPR, 2019. <a href="papers.md#data_Hong_2019_CVPR">info</a></li>
<li> Liang et al., "Peeking Into The Future: Predicting Future Person Activities And Locations In Videos", CVPR, 2019. <a href="papers.md#data_Liang_2019_CVPR">info</a></li>
...
<li> Cui et al., "Multimodal Trajectory Predictions For Autonomous Driving Using Deep Convolutional Networks", ICRA, 2019. <a href="papers.md#data_Cui_2019_ICRA">info</a></li>
<li> Huang et al., "Uncertainty-Aware Driver Trajectory Prediction At Urban Intersections", ICRA, 2019. <a href="papers.md#data_Huang_2019_ICRA">info</a></li>
...
<li> Zhou et al., "Clone Swarms: Learning To Predict And Control Multi-Robot Systems By Imitation", IROS, 2019. <a href="papers.md#data_Zhou_2019_IROS">info</a></li>
...
<li> Chai et al., "Multipath: Multiple Probabilistic Anchor Trajectory Hypotheses For Behavior Prediction", CoRL, 2019. <a href="papers.md#data_Chai_2019_CORL">info</a></li>
<li> Jain et al., "Discrete Residual Flow For Probabilistic Pedestrian Behavior Prediction", CoRL, 2019. <a href="papers.md#data_Jain_2019_CORL">info</a></li>
...
<li> Felsen et al., "Where Will They Go? Predicting Fine-Grained Adversarial Multi-Agent Motion Using Conditional Variational Autoencoders", ECCV, 2018. <a href="papers.md#data_Felsen_2018_ECCV">info</a></li>
...
<li> Shen et al., "Transferable Pedestrian Motion Prediction Models At Intersections", IROS, 2018. <a href="papers.md#data_Shen_2018_IROS">info</a></li>
<li> Zhang et al., "Integrating Kinematics And Environment Context Into Deep Inverse Reinforcement Learning For Predicting Off-Road Vehicle Trajectories", CoRL, 2018. <a href="papers.md#data_Zhang_2018_CORL">info</a></li>
...
<li> Solaimanpour et al., "A Layered Hmm For Predicting Motion Of A Leader In Multi-Robot Settings", ICRA, 2017. <a href="papers.md#data_Solaimanpour_2017_ICRA">info</a></li>
...
<li> Zhou et al., "Learning Time Series Models For Pedestrian Motion Prediction", ICRA, 2016. <a href="papers.md#data_Zhou_2016_ICRA">info</a></li>
...
<li> Baumann et al., "Predicting Ego-Vehicle Paths From Environmental Observations With A Deep Neural Network", ICRA, 2018. <a href="papers.md#data_Baumann_2018_ICRA">info</a></li>
<li> Lee et al., "Robust Human Following By Deep Bayesian Trajectory Prediction For Home Service Robots", ICRA, 2018. <a href="papers.md#data_Lee_2018_ICRA">info</a></li>
...
<li> Karasev et al., "Intent-Aware Long-Term Prediction Of Pedestrian Motion", ICRA, 2016. <a href="papers.md#data_Karasev_2016_ICRA">info</a></li>
<li> Pfeiffer et al., "Predicting Actions To Act Predictably: Cooperative Partial Motion Planning With Maximum Entropy Models", IROS, 2016. <a href="papers.md#data_Pfeiffer_2016_IROS">info</a></li>
...
<li> Chai et al., "Multipath: Multiple Probabilistic Anchor Trajectory Hypotheses For Behavior Prediction", CoRL, 2019. <a href="papers.md#data_Chai_2019_CORL">info</a></li>
<li> Schulz et al., "Interaction-Aware Probabilistic Behavior Prediction In Urban Environments", IROS, 2018. <a href="papers.md#data_Schulz_2018_IROS">info</a></li>
</ul>
</details>
...
<ul>
<li> Rudenko et al., "Joint Long-Term Prediction Of Human Motion Using A Planning-Based Social Force Approach", ICRA, 2018. <a href="papers.md#data_Rudenko_2018_ICRA">info</a></li>
<li> Rudenko et al., "Human Motion Prediction Under Social Grouping Constraints", IROS, 2018. <a href="papers.md#data_Rudenko_2018_IROS">info</a></li>
<li> Lee et al., "Predicting Wide Receiver Trajectories In American Football", WACV, 2016. <a href="papers.md#data_Lee_2016_WACV">info</a></li>
</ul>
</details>
...
<ul>
<li> Hong et al., "Rules Of The Road: Predicting Driving Behavior With A Convolutional Model Of Semantic Interactions", CVPR, 2019. <a href="papers.md#data_Hong_2019_CVPR">info</a></li>
<li> Chen et al., "Augmented Dictionary Learning For Motion Prediction", ICRA, 2016. <a href="papers.md#data_Chen_2016_ICRA">info</a></li>
</ul>
</details>
...
<summary><strong>Used in papers</strong></summary>
<ul>
<li> Shkurti et al., "Topologically Distinct Trajectory Predictions For Probabilistic Pursuit", IROS, 2017. <a href="papers.md#data_Shkurti_2017_IROS">info</a></li>
</ul>
</details>
...
<summary><strong>Used in papers</strong></summary>
<ul>
<li> Rehder et al., "Pedestrian Prediction By Planning Using Deep Neural Networks", ICRA, 2018. <a href="papers.md#data_Rehder_2018_ICRA">info</a></li>
</ul>
</details>
...
<summary><strong>Used in papers</strong></summary>
<ul>
<li> M\ogelmose et al., "Trajectory Analysis And Prediction For Improved Pedestrian Safety: Integrated Framework And Evaluations", IV, 2015. <a href="papers.md#data_Mogelmose_2015_IV">info</a></li>
</ul>
</details>
...
<summary><strong>Used in papers</strong></summary>
<ul>
<li> Bai et al., "Intention-Aware Online Pomdp Planning For Autonomous Driving In A Crowd", ICRA, 2015. <a href="papers.md#data_Bai_2015_ICRA">info</a></li>
</ul>
</details>
...
<li> Talignani et al., "Prediction Of Human Arm Target For Robot Reaching Movements", IROS, 2019. <a href="papers.md#data_Talignani_2019_IROS">info</a></li>
<li> Chiu et al., "Action-Agnostic Human Pose Forecasting", WACV, 2019. <a href="papers.md#data_Chiu_2019_WACV">info</a></li>
<li> Wu et al., "Futurepose - Mixed Reality Martial Arts Training Using Real-Time 3D Human Pose Forecasting With A Rgb Camera", WACV, 2019. <a href="papers.md#data_Wu_2019_WACV">info</a></li>
<li> Yao et al., "Multiple Granularity Group Interaction Prediction", CVPR, 2018. <a href="papers.md#data_Yao_2018_CVPR">info</a></li>
<li> Bütepage et al., "Anticipating Many Futures: Online Human Motion Prediction And Generation For Human-Robot Interaction", ICRA, 2018. <a href="papers.md#data_Butepage_2018_ICRA">info</a></li>
<li> Butepage et al., "Deep Representation Learning For Human Motion Prediction And Classification", CVPR, 2017. <a href="papers.md#data_Butepage_2017_CVPR">info</a></li>
<li> Walker et al., "The Pose Knows: Video Forecasting By Generating Pose Futures", ICCV, 2017. <a href="papers.md#data_Walker_2017_ICCV">info</a></li>
<li> Cao et al., "Forecasting Human Pose And Motion With Multibody Dynamic Model", WACV, 2015. <a href="papers.md#data_Cao_2015_WACV">info</a></li>
</ul>
</details>
...
<li> Kim et al., "Deep-Hurricane-Tracker: Tracking And Forecasting Extreme Climate Events", WACV, 2019. <a href="papers.md#data_Kim_2019_WACV">info</a></li>
<li> Sur et al., "Robots That Anticipate Pain: Anticipating Physical Perturbations From Visual Cues Through Deep Predictive Models", IROS, 2017. <a href="papers.md#data_Sur_2017_IROS">info</a></li>
</ul>
</details>
...
<li> Katyal et al., "Uncertainty-Aware Occupancy Map Prediction Using Generative Networks For Robot Navigation", ICRA, 2019. <a href="papers.md#data_Katyal_2019_ICRA">info</a></li>
<li> Choi et al., "Robust Modeling And Prediction In Dynamic Environments Using Recurrent Flow Networks", IROS, 2016. <a href="papers.md#data_Choi_2016_IROS">info</a></li>
</ul>
</details>
...
<li> Wilson et al., "Vehicle State Prediction For Outdoor Autonomous High-Speed Off-Road Ugvs", ICRA, 2015. <a href="papers.md#data_Wilson_2015_ICRA">info</a></li>
</ul>
</details>
...
<li> Joo et al., "Automated Facial Trait Judgment And Election Outcome Prediction: Social Dimensions Of Face", ICCV, 2015. <a href="papers.md#data_Joo_2015_ICCV">info</a></li>
</ul>
</details>
...
<summary><strong>Used in papers</strong></summary>
<ul>
<li> Graves et al., "Perception As Prediction Using General Value Functions In Autonomous Driving Applications", IROS, 2019. <a href="papers.md#data_Graves_2019_IROS">info</a></li>
<li> Zapf et al., "Pedestrian Density Prediction For Efficient Mobile Robot Exploration", IROS, 2019. <a href="papers.md#data_Zapf_2019_IROS">info</a></li>
</ul>
</details>
...
<li> Schreiber et al., "Long-Term Occupancy Grid Prediction Using Recurrent Neural Networks", ICRA, 2019. <a href="papers.md#data_Schreiber_2019_ICRA">info</a></li>
</ul>
</details>
...
<ul>
<li> Schreiber et al., "Long-Term Occupancy Grid Prediction Using Recurrent Neural Networks", ICRA, 2019. <a href="papers.md#data_Schreiber_2019_ICRA">info</a></li>
<li> Hoermann et al., "Dynamic Occupancy Grid Prediction For Urban Autonomous Driving: A Deep Learning Approach With Fully Automatic Labeling", ICRA, 2018. <a href="papers.md#data_Hoermann_2018_ICRA">info</a></li>
</ul>
</details>
